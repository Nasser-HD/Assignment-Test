...
public class KWSteps {

	WebDriver driver=KWHooks.driver;
	...
	public void Customer_Go_To_Package_Price_KW () {
		String ActualPackagePriceLite=driver.findElement(By.id("currency-lite")).getText();
		String ExpectedPackagePriceLite="1.2 KWD/month";
		...
		String ExpectedPackagePriceClassic="2.5 KWD/month";
		...
		String PackagePricePremium="4.8 KWD/month";
